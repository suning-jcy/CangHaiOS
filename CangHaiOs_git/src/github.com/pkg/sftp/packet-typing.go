...
//func (p sshFxpOpenPacket) isOpenerFile()      {}
...
func (p sshFxpDataPacket) uid() uint64   { return p.Uid }
func (p sshFxpStatusPacket) uid() uint64 { return p.Uid }
func (p sshFxpStatResponse) uid() uint64 { return p.Uid }
func (p sshFxpNamePacket) uid() uint64   { return p.Uid }
func (p sshFxpHandlePacket) uid() uint64 { return p.Uid }
func (p sshFxVersionPacket) uid() uint64 { return 0 }
