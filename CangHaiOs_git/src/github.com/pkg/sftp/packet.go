...
func (p sshFxpReaddirPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpOpendirPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpLstatPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpStatPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpFstatPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpClosePacket) uid() uint64 { return p.Uid }
...
func (p sshFxpRemovePacket) uid() uint64 { return p.Uid }
...
func (p sshFxpRmdirPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpSymlinkPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpReadlinkPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpRealpathPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpOpenPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpReadPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpRenamePacket) uid() uint64 { return p.Uid }
...
func (p sshFxpWritePacket) uid() uint64 { return p.Uid }
...
func (p sshFxpMkdirPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpSetstatPacket) uid() uint64  { return p.Uid }
func (p sshFxpSetstatPacket) id() uint32   { return p.ID }
func (p sshFxpFsetstatPacket) id() uint32  { return p.ID }
func (p sshFxpFsetstatPacket) uid() uint64 { return p.Uid }
...
func (p sshFxpStatusPacket) MarshalBinary() ([]byte, error) {
	...
	b = marshalUint32(b, p.ID)
	//println("ret err p.id", p.ID)
	//println("ret err is", p.StatusError.Code)
	b = marshalStatus(b, p.StatusError)
	//println("ret err b is", b)
	return b, nil
}
...
func (p sshFxpExtendedPacket) uid() uint64    { return p.Uid }
...
func (p sshFxpExtendedPacketStatVFS) uid() uint64    { return p.Uid }
